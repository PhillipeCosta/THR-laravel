        ...
        <table class="w-full whitespace-nowrap" v-else>
            <thead>
                <tr class="text-left font-bold">
                    ...
                    <th class="px-6 pt-6 pb-4">Descrição do Feriado</th>
                    ...
                    >
                        <Dropdown align="right" width="48">
                            ...
                            <template #content>
                                <DropdownLink
                                    :href="
                                        route('feriado.edit', item.id_feriado)
                                    "
                                >
                                    Editar
                                </DropdownLink>
                                <DropdownLink @click="destroy(item.id_feriado)">
                                    Deletar
                                </DropdownLink>
                            </template>
                        </Dropdown>
...
export default {
    ...
    methods: {
        destroy(id) {
            this.$inertia.delete(route("feriado.destroy", id));
        },
        edit(id) {
            this.$emit("edit", id);
        },
